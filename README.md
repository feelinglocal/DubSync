...
The language selector defaults to provider auto-detection. An explicit language is forwarded to the selected transcription provider and becomes part of the cached ASR configuration.
