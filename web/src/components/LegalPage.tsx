...
const privacySections: Section[] = [
  ...
  { title: '4. Service providers', paragraphs: ['DubSync runs primarily on Render infrastructure. In the default cloud workflow, processing can send content to ElevenLabs for speech recognition, OpenAI for bounded punctuation and speaker mapping, and Google Gemini for audio-aware adjudication of dialogue differences. Other providers are used only when configured for a specific job. Their processing is governed by their own terms and data practices.', 'DubSync does not promise zero retention by a provider unless that setting is confirmed for the relevant account and job.'] },
