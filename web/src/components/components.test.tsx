...
describe('shared components', () => {
  ...
  it('renders the terms, privacy, and payment policies', () => {
    ...
    expect(screen.getByText(/OpenAI for bounded punctuation and speaker mapping/)).toBeVisible()
    expect(screen.getByText(/Google Gemini for audio-aware adjudication/)).toBeVisible()
